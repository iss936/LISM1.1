			...
			<script src="${pageContext.request.contextPath}/resources/js/validateFrmAddEtudiant.js" type="text/javascript"></script>
								<div class="titre">Ajouter un étudiant</div>
								<div class="marge_interne">

								<!-- Début de la zone de texte -->
								
								<form name="frmAddEtudiant" action="addEtudiant" method="post">
