			...
			<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
								...
								<form action="addNote" method="post">
									...
									<input type="text" name="prenom" value="${uneEval.etudiant.prenomEtudiant}" disabled="disabled"><br><br>
									
									<label for="nom">Nom</label>
									<input type="text" name="nom" value="${uneEval.etudiant.nomEtudiant}" disabled="disabled"><br><br>
